...
async def collect_flats_from_url(browser, flat_ids: set, url: str):
    ...
    try:
        ...
        for page_num in range(60):
            logger.info(f"🔎 Обрабатываю страницу {page_num + 1}. URL: {url} ")
            ...
            for card in cards:
                try:
                    ...
                    filename = f"data/flats_{date_str}.jsonl"
